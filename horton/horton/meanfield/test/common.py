...
def check_dot_hessian(ham, lf, *dms0):
    ...
    focks0 = [lf.create_two_index() for _i in range(ham.ndm)]
    ham.reset(*dms0)
    ...
    delta_dms = [lf.create_two_index() for _i in range(ham.ndm)]
    dms1 = [lf.create_two_index() for _i in range(ham.ndm)]
    focks1 = [lf.create_two_index() for _i in range(ham.ndm)]
    dots0 = [lf.create_two_index() for _i in range(ham.ndm)]
    dots1 = [lf.create_two_index() for _i in range(ham.ndm)]
